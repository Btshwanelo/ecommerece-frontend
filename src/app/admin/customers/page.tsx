    ...
    <div className="space-y-4 md:space-y-6">
                              ...
                              {customer.profile?.avatar ? (
                                ...
                                <div className="h-10 w-10 rounded-full bg-gray-200 flex items-center justify-center">
                                  <span className="text-gray-600 text-sm font-medium">
                                    {customer.profile?.firstName?.charAt(0) ||
      ...
      {showUserDetails && selectedUser && (
        <div className="fixed inset-0 bg-black/20 backdrop-blur-md overflow-y-auto h-full w-full z-50 p-4">
          <div className="relative border-none top-4 md:top-20 mx-auto p-4 md:p-5 border w-full max-w-2xl shadow-lg rounded-md bg-white">
            <div className="mt-3">
