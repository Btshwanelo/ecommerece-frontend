    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <div className="flex space-x-3">
          <button
            onClick={() => {
              setFilters(prev => ({ ...prev, status: ['draft', 'published', 'archived'] }));
              fetchProducts();
            }}
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                ...
                {Array.isArray(products) && products.length > 0 ? (
                  ...
                  <tr key={product._id}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                      <div>
                        <div className="font-medium">${product.pricing.basePrice.toFixed(2)}</div>
                        {product.pricing.salePrice && (
                          <div className="text-green-600 text-xs">
                            Sale: ${product.pricing.salePrice.toFixed(2)}
                          </div>
                        )}
                      </div>
                    </td>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div>
                        ...
                        <span className={`inline-flex items-center px-1.5 py-0.5 rounded-full text-xs font-medium ${getStockStatusColor(product.inventory.stockStatus)}`}>
